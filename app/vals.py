...
S3_FIRSTCLASS_EXPENSE_QUEUE_KEY = "FIRSTCLASS_EXPENSES_QUEUE.json"
S3_FIRSTCLASS_EXCEPTION_QUEUE_KEY = "FIRSTCLASS_EXCEPTION_QUEUE.json"
S3_FIRSTCLASS_PREV_CLAIM_NUMBERS_KEY = "FIRSTCLASS_PREV_CLAIM_NUMBERS.txt"
